...
{
    public class EntityFrameworkReadOnlyRepository<TContext> : 
                    IReadOnlyRepository
        where TContext : DbContext
    {
        ...
        /// <summary>
        /// Consulta una entidad de la base de datos 
        /// y obtiene sus registros.
        /// </summary>
        /// <typeparam name="TEntity">Tipo de dato de la entidad.</typeparam>
        /// <param name="filter">expresión lambda para realizar el filtrado.</param>
        /// <param name="orderBy">función para realizar el filtrado.</param>
        /// <param name="includeProperties">listado de cuáles propiedades 
        /// se desean consultar recursivamente.</param>
        /// <param name="skip">cantidad inicial de registros a ignorar.</param>
        /// <param name="take">cantidad de elementos 
        /// a considerar en la consulta.</param>
        /// <returns>lista de los registros de la tabla que 
        /// cumplen con las condiciones arriba mencionadas.</returns>
