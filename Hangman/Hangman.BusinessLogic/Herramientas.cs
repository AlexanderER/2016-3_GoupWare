...
namespace Hangman.BusinessLogic
{
    ...
    /// </summary>
    public class Herramientas : ISCPBolt
    {
        ...
        public Herramientas(Context context, Dictionary<string, Object> parms)
        {
            //Set the context
        ...
        public static Herramientas Get(Context context, Dictionary<string, Object> parms)
        {
            return new Herramientas(context, parms);
        }
